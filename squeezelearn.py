...
from keras.layers import Dense, Activation, Flatten, Convolution2D, Conv2DTranspose, ConvLSTM2D, Permute, Reshape
...
model.add(ConvLSTM2D(16, (3, 3), strides=(1, 1), padding='valid'))
model.add(Activation('tanh'))
# analyze and plan
model.add(Convolution2D(32, (3, 3), strides=(1, 1), padding='valid'))
model.add(Activation('relu'))
model.add(Convolution2D(64, (5, 5), strides=(2, 2), padding='valid'))
model.add(Activation('relu'))
model.add(Convolution2D(64, (9, 9), strides=(2, 2), padding='valid'))
model.add(Activation('relu'))
model.add(Dense(512))
model.add(Activation('linear'))
# project
model.add(Conv2DTranspose(64, (9,9), strides=(2,2))
model.add(Activation('relu')
model.add(Conv2DTranspose(32, (5, 5), strides=(2, 2)))
model.add(Activation('relu'))
model.add(Conv2DTranspose(32, (3, 3), strides=(2, 2)))
model.add(Activation('relu'))
model.add(Convolution2D(num_tools, (1, 1), strides=(1, 1), padding='valid'))
model.add(Flatten())
model.add(Activation('linear'))
print(model.summary())
