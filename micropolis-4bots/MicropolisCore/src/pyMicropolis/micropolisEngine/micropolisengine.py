...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_micropolisengine')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_micropolisengine')
...
class StringTable(_object):
    ...
    if _newclass:
        id = _swig_property(_micropolisengine.StringTable_id_get, _micropolisengine.StringTable_id_set)
    ...
    if _newclass:
        lines = _swig_property(_micropolisengine.StringTable_lines_get, _micropolisengine.StringTable_lines_set)
    ...
    if _newclass:
        strings = _swig_property(_micropolisengine.StringTable_strings_get, _micropolisengine.StringTable_strings_set)
    ...
    if _newclass:
        next = _swig_property(_micropolisengine.StringTable_next_get, _micropolisengine.StringTable_next_set)
...
class SimSprite(_object):
    ...
    if _newclass:
        next = _swig_property(_micropolisengine.SimSprite_next_get, _micropolisengine.SimSprite_next_set)
    ...
    if _newclass:
        name = _swig_property(_micropolisengine.SimSprite_name_get, _micropolisengine.SimSprite_name_set)
    ...
    if _newclass:
        type = _swig_property(_micropolisengine.SimSprite_type_get, _micropolisengine.SimSprite_type_set)
    ...
    if _newclass:
        frame = _swig_property(_micropolisengine.SimSprite_frame_get, _micropolisengine.SimSprite_frame_set)
    __swig_setmethods__["x"] = _micropolisengine.SimSprite_x_set
    __swig_getmethods__["x"] = _micropolisengine.SimSprite_x_get
    if _newclass:
        x = _swig_property(_micropolisengine.SimSprite_x_get, _micropolisengine.SimSprite_x_set)
    __swig_setmethods__["y"] = _micropolisengine.SimSprite_y_set
    __swig_getmethods__["y"] = _micropolisengine.SimSprite_y_get
    if _newclass:
        y = _swig_property(_micropolisengine.SimSprite_y_get, _micropolisengine.SimSprite_y_set)
    ...
    if _newclass:
        width = _swig_property(_micropolisengine.SimSprite_width_get, _micropolisengine.SimSprite_width_set)
    ...
    if _newclass:
        height = _swig_property(_micropolisengine.SimSprite_height_get, _micropolisengine.SimSprite_height_set)
    ...
    if _newclass:
        xOffset = _swig_property(_micropolisengine.SimSprite_xOffset_get, _micropolisengine.SimSprite_xOffset_set)
    ...
    if _newclass:
        yOffset = _swig_property(_micropolisengine.SimSprite_yOffset_get, _micropolisengine.SimSprite_yOffset_set)
    ...
    if _newclass:
        xHot = _swig_property(_micropolisengine.SimSprite_xHot_get, _micropolisengine.SimSprite_xHot_set)
    ...
    if _newclass:
        yHot = _swig_property(_micropolisengine.SimSprite_yHot_get, _micropolisengine.SimSprite_yHot_set)
    ...
    if _newclass:
        origX = _swig_property(_micropolisengine.SimSprite_origX_get, _micropolisengine.SimSprite_origX_set)
    ...
    if _newclass:
        origY = _swig_property(_micropolisengine.SimSprite_origY_get, _micropolisengine.SimSprite_origY_set)
    ...
    if _newclass:
        destX = _swig_property(_micropolisengine.SimSprite_destX_get, _micropolisengine.SimSprite_destX_set)
    ...
    if _newclass:
        destY = _swig_property(_micropolisengine.SimSprite_destY_get, _micropolisengine.SimSprite_destY_set)
    ...
    if _newclass:
        count = _swig_property(_micropolisengine.SimSprite_count_get, _micropolisengine.SimSprite_count_set)
    ...
    if _newclass:
        soundCount = _swig_property(_micropolisengine.SimSprite_soundCount_get, _micropolisengine.SimSprite_soundCount_set)
    __swig_setmethods__["dir"] = _micropolisengine.SimSprite_dir_set
    __swig_getmethods__["dir"] = _micropolisengine.SimSprite_dir_get
    if _newclass:
        dir = _swig_property(_micropolisengine.SimSprite_dir_get, _micropolisengine.SimSprite_dir_set)
    ...
    if _newclass:
        newDir = _swig_property(_micropolisengine.SimSprite_newDir_get, _micropolisengine.SimSprite_newDir_set)
    ...
    if _newclass:
        step = _swig_property(_micropolisengine.SimSprite_step_get, _micropolisengine.SimSprite_step_set)
    ...
    if _newclass:
        flag = _swig_property(_micropolisengine.SimSprite_flag_get, _micropolisengine.SimSprite_flag_set)
    ...
    if _newclass:
        control = _swig_property(_micropolisengine.SimSprite_control_get, _micropolisengine.SimSprite_control_set)
    ...
    if _newclass:
        turn = _swig_property(_micropolisengine.SimSprite_turn_get, _micropolisengine.SimSprite_turn_set)
    ...
    if _newclass:
        accel = _swig_property(_micropolisengine.SimSprite_accel_get, _micropolisengine.SimSprite_accel_set)
    ...
    if _newclass:
        speed = _swig_property(_micropolisengine.SimSprite_speed_get, _micropolisengine.SimSprite_speed_set)
...
class Micropolis(_object):
    ...
    if _newclass:
        roadTotal = _swig_property(_micropolisengine.Micropolis_roadTotal_get, _micropolisengine.Micropolis_roadTotal_set)
    ...
    if _newclass:
        railTotal = _swig_property(_micropolisengine.Micropolis_railTotal_get, _micropolisengine.Micropolis_railTotal_set)
    ...
    if _newclass:
        firePop = _swig_property(_micropolisengine.Micropolis_firePop_get, _micropolisengine.Micropolis_firePop_set)
    ...
    if _newclass:
        resPop = _swig_property(_micropolisengine.Micropolis_resPop_get, _micropolisengine.Micropolis_resPop_set)
    ...
    if _newclass:
        comPop = _swig_property(_micropolisengine.Micropolis_comPop_get, _micropolisengine.Micropolis_comPop_set)
    ...
    if _newclass:
        indPop = _swig_property(_micropolisengine.Micropolis_indPop_get, _micropolisengine.Micropolis_indPop_set)
    ...
    if _newclass:
        totalPop = _swig_property(_micropolisengine.Micropolis_totalPop_get, _micropolisengine.Micropolis_totalPop_set)
    ...
    if _newclass:
        totalPopLast = _swig_property(_micropolisengine.Micropolis_totalPopLast_get, _micropolisengine.Micropolis_totalPopLast_set)
    ...
    if _newclass:
        resZonePop = _swig_property(_micropolisengine.Micropolis_resZonePop_get, _micropolisengine.Micropolis_resZonePop_set)
    ...
    if _newclass:
        comZonePop = _swig_property(_micropolisengine.Micropolis_comZonePop_get, _micropolisengine.Micropolis_comZonePop_set)
    ...
    if _newclass:
        indZonePop = _swig_property(_micropolisengine.Micropolis_indZonePop_get, _micropolisengine.Micropolis_indZonePop_set)
    ...
    if _newclass:
        totalZonePop = _swig_property(_micropolisengine.Micropolis_totalZonePop_get, _micropolisengine.Micropolis_totalZonePop_set)
    ...
    if _newclass:
        hospitalPop = _swig_property(_micropolisengine.Micropolis_hospitalPop_get, _micropolisengine.Micropolis_hospitalPop_set)
    ...
    if _newclass:
        churchPop = _swig_property(_micropolisengine.Micropolis_churchPop_get, _micropolisengine.Micropolis_churchPop_set)
    ...
    if _newclass:
        faith = _swig_property(_micropolisengine.Micropolis_faith_get, _micropolisengine.Micropolis_faith_set)
    ...
    if _newclass:
        stadiumPop = _swig_property(_micropolisengine.Micropolis_stadiumPop_get, _micropolisengine.Micropolis_stadiumPop_set)
    ...
    if _newclass:
        policeStationPop = _swig_property(_micropolisengine.Micropolis_policeStationPop_get, _micropolisengine.Micropolis_policeStationPop_set)
    ...
    if _newclass:
        fireStationPop = _swig_property(_micropolisengine.Micropolis_fireStationPop_get, _micropolisengine.Micropolis_fireStationPop_set)
    ...
    if _newclass:
        coalPowerPop = _swig_property(_micropolisengine.Micropolis_coalPowerPop_get, _micropolisengine.Micropolis_coalPowerPop_set)
    ...
    if _newclass:
        nuclearPowerPop = _swig_property(_micropolisengine.Micropolis_nuclearPowerPop_get, _micropolisengine.Micropolis_nuclearPowerPop_set)
    ...
    if _newclass:
        seaportPop = _swig_property(_micropolisengine.Micropolis_seaportPop_get, _micropolisengine.Micropolis_seaportPop_set)
    ...
    if _newclass:
        airportPop = _swig_property(_micropolisengine.Micropolis_airportPop_get, _micropolisengine.Micropolis_airportPop_set)
    ...
    if _newclass:
        crimeAverage = _swig_property(_micropolisengine.Micropolis_crimeAverage_get, _micropolisengine.Micropolis_crimeAverage_set)
    ...
    if _newclass:
        pollutionAverage = _swig_property(_micropolisengine.Micropolis_pollutionAverage_get, _micropolisengine.Micropolis_pollutionAverage_set)
    ...
    if _newclass:
        landValueAverage = _swig_property(_micropolisengine.Micropolis_landValueAverage_get, _micropolisengine.Micropolis_landValueAverage_set)
    ...
    if _newclass:
        cityTime = _swig_property(_micropolisengine.Micropolis_cityTime_get, _micropolisengine.Micropolis_cityTime_set)
    ...
    if _newclass:
        cityMonth = _swig_property(_micropolisengine.Micropolis_cityMonth_get, _micropolisengine.Micropolis_cityMonth_set)
    ...
    if _newclass:
        cityYear = _swig_property(_micropolisengine.Micropolis_cityYear_get, _micropolisengine.Micropolis_cityYear_set)
    ...
    if _newclass:
        startingYear = _swig_property(_micropolisengine.Micropolis_startingYear_get, _micropolisengine.Micropolis_startingYear_set)
    __swig_setmethods__["map"] = _micropolisengine.Micropolis_map_set
    __swig_getmethods__["map"] = _micropolisengine.Micropolis_map_get
    if _newclass:
        map = _swig_property(_micropolisengine.Micropolis_map_get, _micropolisengine.Micropolis_map_set)
    ...
    if _newclass:
        resHist10Max = _swig_property(_micropolisengine.Micropolis_resHist10Max_get, _micropolisengine.Micropolis_resHist10Max_set)
    ...
    if _newclass:
        resHist120Max = _swig_property(_micropolisengine.Micropolis_resHist120Max_get, _micropolisengine.Micropolis_resHist120Max_set)
    ...
    if _newclass:
        comHist10Max = _swig_property(_micropolisengine.Micropolis_comHist10Max_get, _micropolisengine.Micropolis_comHist10Max_set)
    ...
    if _newclass:
        comHist120Max = _swig_property(_micropolisengine.Micropolis_comHist120Max_get, _micropolisengine.Micropolis_comHist120Max_set)
    ...
    if _newclass:
        indHist10Max = _swig_property(_micropolisengine.Micropolis_indHist10Max_get, _micropolisengine.Micropolis_indHist10Max_set)
    ...
    if _newclass:
        indHist120Max = _swig_property(_micropolisengine.Micropolis_indHist120Max_get, _micropolisengine.Micropolis_indHist120Max_set)
    ...
    if _newclass:
        censusChanged = _swig_property(_micropolisengine.Micropolis_censusChanged_get, _micropolisengine.Micropolis_censusChanged_set)
    ...
    if _newclass:
        roadSpend = _swig_property(_micropolisengine.Micropolis_roadSpend_get, _micropolisengine.Micropolis_roadSpend_set)
    ...
    if _newclass:
        policeSpend = _swig_property(_micropolisengine.Micropolis_policeSpend_get, _micropolisengine.Micropolis_policeSpend_set)
    ...
    if _newclass:
        fireSpend = _swig_property(_micropolisengine.Micropolis_fireSpend_get, _micropolisengine.Micropolis_fireSpend_set)
    ...
    if _newclass:
        roadFund = _swig_property(_micropolisengine.Micropolis_roadFund_get, _micropolisengine.Micropolis_roadFund_set)
    ...
    if _newclass:
        policeFund = _swig_property(_micropolisengine.Micropolis_policeFund_get, _micropolisengine.Micropolis_policeFund_set)
    ...
    if _newclass:
        fireFund = _swig_property(_micropolisengine.Micropolis_fireFund_get, _micropolisengine.Micropolis_fireFund_set)
    ...
    if _newclass:
        roadEffect = _swig_property(_micropolisengine.Micropolis_roadEffect_get, _micropolisengine.Micropolis_roadEffect_set)
    ...
    if _newclass:
        policeEffect = _swig_property(_micropolisengine.Micropolis_policeEffect_get, _micropolisengine.Micropolis_policeEffect_set)
    ...
    if _newclass:
        fireEffect = _swig_property(_micropolisengine.Micropolis_fireEffect_get, _micropolisengine.Micropolis_fireEffect_set)
    ...
    if _newclass:
        taxFund = _swig_property(_micropolisengine.Micropolis_taxFund_get, _micropolisengine.Micropolis_taxFund_set)
    ...
    if _newclass:
        cityTax = _swig_property(_micropolisengine.Micropolis_cityTax_get, _micropolisengine.Micropolis_cityTax_set)
    ...
    if _newclass:
        taxFlag = _swig_property(_micropolisengine.Micropolis_taxFlag_get, _micropolisengine.Micropolis_taxFlag_set)
    ...
    if _newclass:
        populationDensityMap = _swig_property(_micropolisengine.Micropolis_populationDensityMap_get, _micropolisengine.Micropolis_populationDensityMap_set)
    ...
    if _newclass:
        trafficDensityMap = _swig_property(_micropolisengine.Micropolis_trafficDensityMap_get, _micropolisengine.Micropolis_trafficDensityMap_set)
    ...
    if _newclass:
        pollutionDensityMap = _swig_property(_micropolisengine.Micropolis_pollutionDensityMap_get, _micropolisengine.Micropolis_pollutionDensityMap_set)
    ...
    if _newclass:
        landValueMap = _swig_property(_micropolisengine.Micropolis_landValueMap_get, _micropolisengine.Micropolis_landValueMap_set)
    ...
    if _newclass:
        crimeRateMap = _swig_property(_micropolisengine.Micropolis_crimeRateMap_get, _micropolisengine.Micropolis_crimeRateMap_set)
    ...
    if _newclass:
        terrainDensityMap = _swig_property(_micropolisengine.Micropolis_terrainDensityMap_get, _micropolisengine.Micropolis_terrainDensityMap_set)
    ...
    if _newclass:
        tempMap1 = _swig_property(_micropolisengine.Micropolis_tempMap1_get, _micropolisengine.Micropolis_tempMap1_set)
    ...
    if _newclass:
        tempMap2 = _swig_property(_micropolisengine.Micropolis_tempMap2_get, _micropolisengine.Micropolis_tempMap2_set)
    ...
    if _newclass:
        tempMap3 = _swig_property(_micropolisengine.Micropolis_tempMap3_get, _micropolisengine.Micropolis_tempMap3_set)
    ...
    if _newclass:
        powerGridMap = _swig_property(_micropolisengine.Micropolis_powerGridMap_get, _micropolisengine.Micropolis_powerGridMap_set)
    ...
    if _newclass:
        rateOfGrowthMap = _swig_property(_micropolisengine.Micropolis_rateOfGrowthMap_get, _micropolisengine.Micropolis_rateOfGrowthMap_set)
    ...
    if _newclass:
        fireStationMap = _swig_property(_micropolisengine.Micropolis_fireStationMap_get, _micropolisengine.Micropolis_fireStationMap_set)
    ...
    if _newclass:
        fireStationEffectMap = _swig_property(_micropolisengine.Micropolis_fireStationEffectMap_get, _micropolisengine.Micropolis_fireStationEffectMap_set)
    ...
    if _newclass:
        policeStationMap = _swig_property(_micropolisengine.Micropolis_policeStationMap_get, _micropolisengine.Micropolis_policeStationMap_set)
    ...
    if _newclass:
        policeStationEffectMap = _swig_property(_micropolisengine.Micropolis_policeStationEffectMap_get, _micropolisengine.Micropolis_policeStationEffectMap_set)
    ...
    if _newclass:
        comRateMap = _swig_property(_micropolisengine.Micropolis_comRateMap_get, _micropolisengine.Micropolis_comRateMap_set)
    ...
    if _newclass:
        resHist = _swig_property(_micropolisengine.Micropolis_resHist_get, _micropolisengine.Micropolis_resHist_set)
    ...
    if _newclass:
        comHist = _swig_property(_micropolisengine.Micropolis_comHist_get, _micropolisengine.Micropolis_comHist_set)
    ...
    if _newclass:
        indHist = _swig_property(_micropolisengine.Micropolis_indHist_get, _micropolisengine.Micropolis_indHist_set)
    ...
    if _newclass:
        moneyHist = _swig_property(_micropolisengine.Micropolis_moneyHist_get, _micropolisengine.Micropolis_moneyHist_set)
    ...
    if _newclass:
        pollutionHist = _swig_property(_micropolisengine.Micropolis_pollutionHist_get, _micropolisengine.Micropolis_pollutionHist_set)
    ...
    if _newclass:
        crimeHist = _swig_property(_micropolisengine.Micropolis_crimeHist_get, _micropolisengine.Micropolis_crimeHist_set)
    ...
    if _newclass:
        miscHist = _swig_property(_micropolisengine.Micropolis_miscHist_get, _micropolisengine.Micropolis_miscHist_set)

    def animateTiles(self):
        return _micropolisengine.Micropolis_animateTiles(self)
    if _newclass:
        getNextAnimatedTile = staticmethod(_micropolisengine.Micropolis_getNextAnimatedTile)
    else:
        getNextAnimatedTile = _micropolisengine.Micropolis_getNextAnimatedTile
    ...
    if _newclass:
        roadPercent = _swig_property(_micropolisengine.Micropolis_roadPercent_get, _micropolisengine.Micropolis_roadPercent_set)
    ...
    if _newclass:
        policePercent = _swig_property(_micropolisengine.Micropolis_policePercent_get, _micropolisengine.Micropolis_policePercent_set)
    ...
    if _newclass:
        firePercent = _swig_property(_micropolisengine.Micropolis_firePercent_get, _micropolisengine.Micropolis_firePercent_set)
    ...
    if _newclass:
        roadValue = _swig_property(_micropolisengine.Micropolis_roadValue_get, _micropolisengine.Micropolis_roadValue_set)
    ...
    if _newclass:
        policeValue = _swig_property(_micropolisengine.Micropolis_policeValue_get, _micropolisengine.Micropolis_policeValue_set)
    ...
    if _newclass:
        fireValue = _swig_property(_micropolisengine.Micropolis_fireValue_get, _micropolisengine.Micropolis_fireValue_set)
    ...
    if _newclass:
        mustDrawBudget = _swig_property(_micropolisengine.Micropolis_mustDrawBudget_get, _micropolisengine.Micropolis_mustDrawBudget_set)
    ...
    if _newclass:
        floodCount = _swig_property(_micropolisengine.Micropolis_floodCount_get, _micropolisengine.Micropolis_floodCount_set)
    ...
    if _newclass:
        cityYes = _swig_property(_micropolisengine.Micropolis_cityYes_get, _micropolisengine.Micropolis_cityYes_set)
    ...
    if _newclass:
        problemVotes = _swig_property(_micropolisengine.Micropolis_problemVotes_get, _micropolisengine.Micropolis_problemVotes_set)
    ...
    if _newclass:
        problemOrder = _swig_property(_micropolisengine.Micropolis_problemOrder_get, _micropolisengine.Micropolis_problemOrder_set)
    ...
    if _newclass:
        cityPop = _swig_property(_micropolisengine.Micropolis_cityPop_get, _micropolisengine.Micropolis_cityPop_set)
    ...
    if _newclass:
        cityPopDelta = _swig_property(_micropolisengine.Micropolis_cityPopDelta_get, _micropolisengine.Micropolis_cityPopDelta_set)
    ...
    if _newclass:
        cityAssessedValue = _swig_property(_micropolisengine.Micropolis_cityAssessedValue_get, _micropolisengine.Micropolis_cityAssessedValue_set)
    ...
    if _newclass:
        cityClass = _swig_property(_micropolisengine.Micropolis_cityClass_get, _micropolisengine.Micropolis_cityClass_set)
    ...
    if _newclass:
        cityScore = _swig_property(_micropolisengine.Micropolis_cityScore_get, _micropolisengine.Micropolis_cityScore_set)
    ...
    if _newclass:
        cityScoreDelta = _swig_property(_micropolisengine.Micropolis_cityScoreDelta_get, _micropolisengine.Micropolis_cityScoreDelta_set)
    ...
    if _newclass:
        trafficAverage = _swig_property(_micropolisengine.Micropolis_trafficAverage_get, _micropolisengine.Micropolis_trafficAverage_set)
    ...
    if _newclass:
        terrainTreeLevel = _swig_property(_micropolisengine.Micropolis_terrainTreeLevel_get, _micropolisengine.Micropolis_terrainTreeLevel_set)
    ...
    if _newclass:
        terrainLakeLevel = _swig_property(_micropolisengine.Micropolis_terrainLakeLevel_get, _micropolisengine.Micropolis_terrainLakeLevel_set)
    ...
    if _newclass:
        terrainCurveLevel = _swig_property(_micropolisengine.Micropolis_terrainCurveLevel_get, _micropolisengine.Micropolis_terrainCurveLevel_set)
    ...
    if _newclass:
        terrainCreateIsland = _swig_property(_micropolisengine.Micropolis_terrainCreateIsland_get, _micropolisengine.Micropolis_terrainCreateIsland_set)
    __swig_setmethods__["generatedCitySeed"] = _micropolisengine.Micropolis_generatedCitySeed_set
    __swig_getmethods__["generatedCitySeed"] = _micropolisengine.Micropolis_generatedCitySeed_get
    if _newclass:
        generatedCitySeed = _swig_property(_micropolisengine.Micropolis_generatedCitySeed_get, _micropolisengine.Micropolis_generatedCitySeed_set)
    ...
    if _newclass:
        historyInitialized = _swig_property(_micropolisengine.Micropolis_historyInitialized_get, _micropolisengine.Micropolis_historyInitialized_set)
    ...
    if _newclass:
        graph10Max = _swig_property(_micropolisengine.Micropolis_graph10Max_get, _micropolisengine.Micropolis_graph10Max_set)
    ...
    if _newclass:
        graph120Max = _swig_property(_micropolisengine.Micropolis_graph120Max_get, _micropolisengine.Micropolis_graph120Max_set)
    ...
    if _newclass:
        simLoops = _swig_property(_micropolisengine.Micropolis_simLoops_get, _micropolisengine.Micropolis_simLoops_set)
    ...
    if _newclass:
        simPasses = _swig_property(_micropolisengine.Micropolis_simPasses_get, _micropolisengine.Micropolis_simPasses_set)
    ...
    if _newclass:
        simPass = _swig_property(_micropolisengine.Micropolis_simPass_get, _micropolisengine.Micropolis_simPass_set)
    ...
    if _newclass:
        simPaused = _swig_property(_micropolisengine.Micropolis_simPaused_get, _micropolisengine.Micropolis_simPaused_set)
    ...
    if _newclass:
        simPausedSpeed = _swig_property(_micropolisengine.Micropolis_simPausedSpeed_get, _micropolisengine.Micropolis_simPausedSpeed_set)
    ...
    if _newclass:
        tilesAnimated = _swig_property(_micropolisengine.Micropolis_tilesAnimated_get, _micropolisengine.Micropolis_tilesAnimated_set)
    ...
    if _newclass:
        doAnimation = _swig_property(_micropolisengine.Micropolis_doAnimation_get, _micropolisengine.Micropolis_doAnimation_set)
    ...
    if _newclass:
        doMessages = _swig_property(_micropolisengine.Micropolis_doMessages_get, _micropolisengine.Micropolis_doMessages_set)
    ...
    if _newclass:
        doNotices = _swig_property(_micropolisengine.Micropolis_doNotices_get, _micropolisengine.Micropolis_doNotices_set)
    ...
    if _newclass:
        cityFileName = _swig_property(_micropolisengine.Micropolis_cityFileName_get, _micropolisengine.Micropolis_cityFileName_set)
    ...
    if _newclass:
        cityName = _swig_property(_micropolisengine.Micropolis_cityName_get, _micropolisengine.Micropolis_cityName_set)
    ...
    if _newclass:
        cityPopLast = _swig_property(_micropolisengine.Micropolis_cityPopLast_get, _micropolisengine.Micropolis_cityPopLast_set)
    ...
    if _newclass:
        categoryLast = _swig_property(_micropolisengine.Micropolis_categoryLast_get, _micropolisengine.Micropolis_categoryLast_set)
    ...
    if _newclass:
        autoGoto = _swig_property(_micropolisengine.Micropolis_autoGoto_get, _micropolisengine.Micropolis_autoGoto_set)
    ...
    if _newclass:
        homeDir = _swig_property(_micropolisengine.Micropolis_homeDir_get, _micropolisengine.Micropolis_homeDir_set)
    ...
    if _newclass:
        resourceDir = _swig_property(_micropolisengine.Micropolis_resourceDir_get, _micropolisengine.Micropolis_resourceDir_set)
    ...
    if _newclass:
        resources = _swig_property(_micropolisengine.Micropolis_resources_get, _micropolisengine.Micropolis_resources_set)
    ...
    if _newclass:
        stringTables = _swig_property(_micropolisengine.Micropolis_stringTables_get, _micropolisengine.Micropolis_stringTables_set)
    ...
    if _newclass:
        valveFlag = _swig_property(_micropolisengine.Micropolis_valveFlag_get, _micropolisengine.Micropolis_valveFlag_set)
    ...
    if _newclass:
        crimeRamp = _swig_property(_micropolisengine.Micropolis_crimeRamp_get, _micropolisengine.Micropolis_crimeRamp_set)
    ...
    if _newclass:
        pollutionRamp = _swig_property(_micropolisengine.Micropolis_pollutionRamp_get, _micropolisengine.Micropolis_pollutionRamp_set)
    ...
    if _newclass:
        resCap = _swig_property(_micropolisengine.Micropolis_resCap_get, _micropolisengine.Micropolis_resCap_set)
    ...
    if _newclass:
        comCap = _swig_property(_micropolisengine.Micropolis_comCap_get, _micropolisengine.Micropolis_comCap_set)
    ...
    if _newclass:
        indCap = _swig_property(_micropolisengine.Micropolis_indCap_get, _micropolisengine.Micropolis_indCap_set)
    ...
    if _newclass:
        cashFlow = _swig_property(_micropolisengine.Micropolis_cashFlow_get, _micropolisengine.Micropolis_cashFlow_set)
    ...
    if _newclass:
        externalMarket = _swig_property(_micropolisengine.Micropolis_externalMarket_get, _micropolisengine.Micropolis_externalMarket_set)
    ...
    if _newclass:
        disasterEvent = _swig_property(_micropolisengine.Micropolis_disasterEvent_get, _micropolisengine.Micropolis_disasterEvent_set)
    ...
    if _newclass:
        disasterWait = _swig_property(_micropolisengine.Micropolis_disasterWait_get, _micropolisengine.Micropolis_disasterWait_set)
    ...
    if _newclass:
        scoreType = _swig_property(_micropolisengine.Micropolis_scoreType_get, _micropolisengine.Micropolis_scoreType_set)
    ...
    if _newclass:
        scoreWait = _swig_property(_micropolisengine.Micropolis_scoreWait_get, _micropolisengine.Micropolis_scoreWait_set)
    ...
    if _newclass:
        poweredZoneCount = _swig_property(_micropolisengine.Micropolis_poweredZoneCount_get, _micropolisengine.Micropolis_poweredZoneCount_set)
    ...
    if _newclass:
        unpoweredZoneCount = _swig_property(_micropolisengine.Micropolis_unpoweredZoneCount_get, _micropolisengine.Micropolis_unpoweredZoneCount_set)
    ...
    if _newclass:
        newPower = _swig_property(_micropolisengine.Micropolis_newPower_get, _micropolisengine.Micropolis_newPower_set)
    ...
    if _newclass:
        cityTaxAverage = _swig_property(_micropolisengine.Micropolis_cityTaxAverage_get, _micropolisengine.Micropolis_cityTaxAverage_set)
    ...
    if _newclass:
        simCycle = _swig_property(_micropolisengine.Micropolis_simCycle_get, _micropolisengine.Micropolis_simCycle_set)
    ...
    if _newclass:
        phaseCycle = _swig_property(_micropolisengine.Micropolis_phaseCycle_get, _micropolisengine.Micropolis_phaseCycle_set)
    ...
    if _newclass:
        speedCycle = _swig_property(_micropolisengine.Micropolis_speedCycle_get, _micropolisengine.Micropolis_speedCycle_set)
    ...
    if _newclass:
        doInitialEval = _swig_property(_micropolisengine.Micropolis_doInitialEval_get, _micropolisengine.Micropolis_doInitialEval_set)
    ...
    if _newclass:
        mapSerial = _swig_property(_micropolisengine.Micropolis_mapSerial_get, _micropolisengine.Micropolis_mapSerial_set)
    ...
    if _newclass:
        spriteList = _swig_property(_micropolisengine.Micropolis_spriteList_get, _micropolisengine.Micropolis_spriteList_set)
    ...
    if _newclass:
        totalFunds = _swig_property(_micropolisengine.Micropolis_totalFunds_get, _micropolisengine.Micropolis_totalFunds_set)
    ...
    if _newclass:
        autoBulldoze = _swig_property(_micropolisengine.Micropolis_autoBulldoze_get, _micropolisengine.Micropolis_autoBulldoze_set)
    ...
    if _newclass:
        autoBudget = _swig_property(_micropolisengine.Micropolis_autoBudget_get, _micropolisengine.Micropolis_autoBudget_set)
    ...
    if _newclass:
        messageTimeLast = _swig_property(_micropolisengine.Micropolis_messageTimeLast_get, _micropolisengine.Micropolis_messageTimeLast_set)
    ...
    if _newclass:
        gameLevel = _swig_property(_micropolisengine.Micropolis_gameLevel_get, _micropolisengine.Micropolis_gameLevel_set)
    ...
    if _newclass:
        initSimLoad = _swig_property(_micropolisengine.Micropolis_initSimLoad_get, _micropolisengine.Micropolis_initSimLoad_set)
    ...
    if _newclass:
        scenario = _swig_property(_micropolisengine.Micropolis_scenario_get, _micropolisengine.Micropolis_scenario_set)
    ...
    if _newclass:
        simSpeed = _swig_property(_micropolisengine.Micropolis_simSpeed_get, _micropolisengine.Micropolis_simSpeed_set)
    ...
    if _newclass:
        simSpeedMeta = _swig_property(_micropolisengine.Micropolis_simSpeedMeta_get, _micropolisengine.Micropolis_simSpeedMeta_set)
    ...
    if _newclass:
        enableSound = _swig_property(_micropolisengine.Micropolis_enableSound_get, _micropolisengine.Micropolis_enableSound_set)
    ...
    if _newclass:
        enableDisasters = _swig_property(_micropolisengine.Micropolis_enableDisasters_get, _micropolisengine.Micropolis_enableDisasters_set)
    ...
    if _newclass:
        messageNumber = _swig_property(_micropolisengine.Micropolis_messageNumber_get, _micropolisengine.Micropolis_messageNumber_set)
    ...
    if _newclass:
        evalChanged = _swig_property(_micropolisengine.Micropolis_evalChanged_get, _micropolisengine.Micropolis_evalChanged_set)
    ...
    if _newclass:
        blinkFlag = _swig_property(_micropolisengine.Micropolis_blinkFlag_get, _micropolisengine.Micropolis_blinkFlag_set)
    ...
    if _newclass:
        callbackHook = _swig_property(_micropolisengine.Micropolis_callbackHook_get, _micropolisengine.Micropolis_callbackHook_set)
    ...
    if _newclass:
        callbackData = _swig_property(_micropolisengine.Micropolis_callbackData_get, _micropolisengine.Micropolis_callbackData_set)
    ...
    if _newclass:
        userData = _swig_property(_micropolisengine.Micropolis_userData_get, _micropolisengine.Micropolis_userData_set)
    if _newclass:
        testBounds = staticmethod(_micropolisengine.Micropolis_testBounds)
    else:
        testBounds = _micropolisengine.Micropolis_testBounds
    ...
    if _newclass:
        mustUpdateFunds = _swig_property(_micropolisengine.Micropolis_mustUpdateFunds_get, _micropolisengine.Micropolis_mustUpdateFunds_set)
    ...
    if _newclass:
        mustUpdateOptions = _swig_property(_micropolisengine.Micropolis_mustUpdateOptions_get, _micropolisengine.Micropolis_mustUpdateOptions_set)
    ...
    if _newclass:
        cityTimeLast = _swig_property(_micropolisengine.Micropolis_cityTimeLast_get, _micropolisengine.Micropolis_cityTimeLast_set)
    ...
    if _newclass:
        cityYearLast = _swig_property(_micropolisengine.Micropolis_cityYearLast_get, _micropolisengine.Micropolis_cityYearLast_set)
    ...
    if _newclass:
        cityMonthLast = _swig_property(_micropolisengine.Micropolis_cityMonthLast_get, _micropolisengine.Micropolis_cityMonthLast_set)
    ...
    if _newclass:
        totalFundsLast = _swig_property(_micropolisengine.Micropolis_totalFundsLast_get, _micropolisengine.Micropolis_totalFundsLast_set)
    ...
    if _newclass:
        resLast = _swig_property(_micropolisengine.Micropolis_resLast_get, _micropolisengine.Micropolis_resLast_set)
    ...
    if _newclass:
        comLast = _swig_property(_micropolisengine.Micropolis_comLast_get, _micropolisengine.Micropolis_comLast_set)
    ...
    if _newclass:
        indLast = _swig_property(_micropolisengine.Micropolis_indLast_get, _micropolisengine.Micropolis_indLast_set)
...
def Micropolis_getNextAnimatedTile(index):
...
def Micropolis_testBounds(wx, wy):
...
class MapByte1(_object):
    ...
    if _newclass:
        MAP_BLOCKSIZE = _swig_property(_micropolisengine.MapByte1_MAP_BLOCKSIZE_get)
    __swig_getmethods__["MAP_W"] = _micropolisengine.MapByte1_MAP_W_get
    if _newclass:
        MAP_W = _swig_property(_micropolisengine.MapByte1_MAP_W_get)
    __swig_getmethods__["MAP_H"] = _micropolisengine.MapByte1_MAP_H_get
    if _newclass:
        MAP_H = _swig_property(_micropolisengine.MapByte1_MAP_H_get)
...
class MapByte2(_object):
    ...
    if _newclass:
        MAP_BLOCKSIZE = _swig_property(_micropolisengine.MapByte2_MAP_BLOCKSIZE_get)
    __swig_getmethods__["MAP_W"] = _micropolisengine.MapByte2_MAP_W_get
    if _newclass:
        MAP_W = _swig_property(_micropolisengine.MapByte2_MAP_W_get)
    __swig_getmethods__["MAP_H"] = _micropolisengine.MapByte2_MAP_H_get
    if _newclass:
        MAP_H = _swig_property(_micropolisengine.MapByte2_MAP_H_get)
...
class MapByte4(_object):
    ...
    if _newclass:
        MAP_BLOCKSIZE = _swig_property(_micropolisengine.MapByte4_MAP_BLOCKSIZE_get)
    __swig_getmethods__["MAP_W"] = _micropolisengine.MapByte4_MAP_W_get
    if _newclass:
        MAP_W = _swig_property(_micropolisengine.MapByte4_MAP_W_get)
    __swig_getmethods__["MAP_H"] = _micropolisengine.MapByte4_MAP_H_get
    if _newclass:
        MAP_H = _swig_property(_micropolisengine.MapByte4_MAP_H_get)
...
class MapShort8(_object):
    ...
    if _newclass:
        MAP_BLOCKSIZE = _swig_property(_micropolisengine.MapShort8_MAP_BLOCKSIZE_get)
    __swig_getmethods__["MAP_W"] = _micropolisengine.MapShort8_MAP_W_get
    if _newclass:
        MAP_W = _swig_property(_micropolisengine.MapShort8_MAP_W_get)
    __swig_getmethods__["MAP_H"] = _micropolisengine.MapShort8_MAP_H_get
    if _newclass:
        MAP_H = _swig_property(_micropolisengine.MapShort8_MAP_H_get)
