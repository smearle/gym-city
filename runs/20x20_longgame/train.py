...
model.add(Convolution2D(32, (19, 19), strides=(1, 1), padding='same'))
model.add(Activation('relu'))
model.add(Convolution2D(64, (11, 11), strides=(1, 1), padding='same'))
model.add(Activation('relu'))
...
model.add(Activation('relu'))
# choose actions
model.add(Convolution2D(num_tools, (21, 21), strides=(1,1), padding='same'))
model.add(Flatten())
...
#        dqn.model.load(args.loadmodel)
    ...
    dqn.fit(env, callbacks=callbacks, nb_steps=3500000, log_interval=10000)
