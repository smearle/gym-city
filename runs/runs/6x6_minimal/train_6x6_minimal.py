...
model.add(Convolution2D(num_tools, (6, 6), strides=(1, 1), padding='same'))
...
if args.mode == 'train':
    ...
    os.chdir('/home/sme/gym-micropolis/runs')
    rundir= 'kerasdqn_{}'.format(time())
    os.mkdir(rundir)
    os.chdir(rundir)
    weights_filename = 'dqn_micropolis_weights.h5f'
    checkpoint_weights_filename = 'dqn_micropolis_{step}.h5f'
